...
Generated: `2026-09-19T08:11:39+00:00`
...
| --- | --- | --- | --- | --- | --- |
| localhost | system | system | yes | 0.3 ms | 127.0.0.1, ::1 |
| localhost | 127.0.0.1 | A | no | 1000.2 ms |  |
| localhost | 127.0.0.1 | AAAA | no | 1001.0 ms |  |
| localhost | 127.0.0.1 | TXT | no | 1000.6 ms |  |
...
| --- | --- | --- | --- | --- |
| 1 | 127.0.0.1 | 0.2 ms | skipped | n/a |
